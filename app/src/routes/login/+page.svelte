...
<style>
  .login_img_section {
  background: linear-gradient(rgba(2,2,2,.7),rgba(0,0,0,.7)),url(https://assets.promediateknologi.com/crop/0x0:0x0/x/photo/2022/01/10/3635338338.jpeg) center center;
}
</style>
<div class="h-screen flex">
          ...
          justify-around items-center">
            ...
            <div class="w-full mx-auto px-20 flex-col items-center space-y-6">
              <h1 class="text-white font-bold text-4xl font-sans">Ngelingke</h1>
              <p class="text-white mt-1">Javanese is a Malayo-Polynesian language spoken by the Javanese people from the central and eastern parts of the island of Java, Indonesia. There are also pockets of Javanese speakers on the northern coast of western Java. It is the native language of more than 98 million people.</p>
